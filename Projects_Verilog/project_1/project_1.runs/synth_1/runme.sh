...
HD_PWD='D:/Projects_Verilog/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top1.tcl
