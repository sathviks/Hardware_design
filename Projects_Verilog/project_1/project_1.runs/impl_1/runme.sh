...
HD_PWD='D:/Projects_Verilog/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top1.tcl -notrace
